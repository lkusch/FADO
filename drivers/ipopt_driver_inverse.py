...
class IpoptDriverInverse(ConstrainedOptimizationDriver):
    """
    ...
    def _eval_grad_f(self, x, out):
        ...
        try:
            ...
            for obj in self._objectives:
                out += 2*(obj.function.getValue()-obj.target)*obj.function.getGradient(self._variableStartMask) * obj.scale
            out /= self._varScales
